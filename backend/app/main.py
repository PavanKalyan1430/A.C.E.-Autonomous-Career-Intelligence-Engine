...
async def lifespan(app: FastAPI):
    ...
    if not connected:
        ...
        try:
            ...
            # Self-healing column additions for existing production tables - separate transactions so one failure doesn't abort others
            migration_sqls = [
            ...
            for sql_stmt in migration_sqls:
                try:
                    ...
                    logger.warning(f"Schema migration statement warning for '{sql_stmt}': {col_err}")
